...
public class RuleStorageTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			rsa.deleteAction(-1);
			rsa.deleteRule(-1);
			rsa.updateAction(-1, null, null, null, null, null);
...
//			ruleIds.add(rsa.addRule(situation, buildActionList()));
			...
			rsa.getAllRules().forEach(
					rule -> System.out.println(rule.toString()));

			// print actions of rule 1, get by id
			System.out.println(rsa.getActionsByRuleID(ruleIds.get(0))
					.toString());
			...
			rsa.updateAction(actionID, "neu", null, null, null, null);
			rsa.updateAction(actionID, null, "neu", null, null, null);
			rsa.updateAction(actionID, null, null, "neu", null, null);
			HashMap<String, String> params = new HashMap<>();
			params.put("neu1", "value1");
			params.put("neu2", "value2");

			rsa.updateAction(actionID, null, null, null, null, params);
			// print actions of rule 1, get by id
			System.out.println(rsa.getActionsByRuleID(ruleIds.get(0))
					.toString());
...
//			situation.setSituationName("situation3");
	...
	private static Action buildAction() {
		...
		Action action = new Action("ExamplePlugin", "ExampleAddress",
				"ExampleMessage", ExecutionTime.onSituationChange, params);
		return action;
