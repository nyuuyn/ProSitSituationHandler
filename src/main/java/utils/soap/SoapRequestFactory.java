...
public class SoapRequestFactory {
	 ...
	 */
	public static WsaSoapMessage createRollbackRequest(String receiver, String relatedMessageId, String recipentNS) {
		try {
			...
			addWsaHeaders(envelope, receiver, true, relatedMessageId, SoapConstants.RELATIONSHIP_TYPE_ROLLBACK,
					replyToAddress, recipentNS + "/" + ROLLBACK_START_OPERATION);
			...
			SOAPBodyElement startRollbackElement = body.addBodyElement(
					envelope.createQName(SoapConstants.ROLLBACK_START_OPERATION_ELEMENT, ROLLBACK_MESSAGE_NAMESPACE_PREFIX));

			SOAPElement releatedRequestIdElement = startRollbackElement
					.addChildElement(envelope.createName(SoapConstants.ROLLBACK_MESSAGE_RELATED_ID_ELEMENT));
	 ...
	 * @see SOAPConstants
	 */
	public static WsaSoapMessage createFaultMessageWsa(String receiver, String relatedMessageId, Operation operation,
		...
		try {
			...
			addWsaHeaders(envelope, receiver, false, relatedMessageId, SoapConstants.RELATIONSHIP_TYPE_RESPONSE, null,
	 ...
	 * 
	 */
	private static void addWsaHeaders(SOAPEnvelope env, String receiver, boolean idRequired, String releatesToId,
			String relatesToType, String replyToAddress, String actionHeader) throws SOAPException {

		SOAPHeader header = env.getHeader();
		header = (SOAPHeader) header.addNamespaceDeclaration(SoapConstants.DEFAULT_WSA_PREFIX, SoapConstants.WSA_URI);

		// to
		SOAPHeaderElement to = header.addHeaderElement(header.createQName("To", SoapConstants.DEFAULT_WSA_PREFIX));
	 ...
	 */
	private static WsaSoapMessage createTheMessage(SOAPMessage msg) throws SOAPException, IOException {
