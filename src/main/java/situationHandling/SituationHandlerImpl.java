...
import situationHandling.storage.RuleStorageAccessImpl_Dummy;
...
public class SituationHandlerImpl extends RouteBuilder implements
	...
	private static RuleStorageAccessImpl_Dummy ruleStorage = new RuleStorageAccessImpl_Dummy();;
	...
	public RuleStorageAccessImpl_Dummy getRuleStorage() {
		return ruleStorage;
	}
